            ...
            <form action="edit_page.php?page=<?php echo urlencode($selected_page['id']); ?>" method="post" class="form-subject">
                ...
                <div class="form-group">
                    ...
                    <select name="position" id="position" class="input-select">
                        ...
                        for ($count = 1; $count <= $page_count + 1; $count++) {
                            ...
                            if ($selected_page['position'] === $count) { echo " selected";
                            }
                            echo ">{$count}</option>";
                        }
                        ?>
                ...
                <div class="form-group">
                    ...
                    <label class="radio-option">
                        <input type="radio" name="visible" value="0" <?php if ($selected_page['visible'] === 0) { echo "checked";
                                                                     } ?> /> No
                    </label>
                    <label class="radio-option">
                        <input type="radio" name="visible" value="1" <?php if ($selected_page['visible'] === 1) { echo "checked";
                                                                     } ?> /> Yes
                    </label>
                </div>
